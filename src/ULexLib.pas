...
(* 
Update by Uto Dev (utodev@gmail.com) in 2019 to provide support for AnsiStrings. 
The following text is here just for SEO reasons, hoping it can be easily found
by others in my situation: AnsiString, Plex, long tokens, LongString, fpc, 
free pascal *)   
  ...
  begin
    if (bufptr=0) and not eof(yyinput) then
      begin
        ...
        begin
          tmpStr := copy(yyline,length(yyline)-i+1,1);
          buf[i+1] := tmpStr[1];
        end;

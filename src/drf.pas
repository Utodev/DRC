...
BEGIN
  ...
  WriteLn('For ZX the values can be 48K, PLUS3, ESXDOS, UNO or NEXT.');
...
BEGIN
 ...
 if Target='ZX' THEN Result :=  (Subtarget = 'PLUS3') OR (Subtarget = 'ESXDOS') OR  (Subtarget = 'NEXT') OR  (Subtarget = 'UNO') OR (Subtarget = '48K');
END;
